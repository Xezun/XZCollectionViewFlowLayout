//
//  ExampleEdgeInsetsViewController.m
//  Example
//
...
@interface ExampleEdgeInsetsViewController ()

@end

@implementation ExampleEdgeInsetsViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if (![vc isKindOfClass:[ExampleSelectNumberViewController class]]) {
        return;
    }
