...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/Xezun/XZCollectionViewFlowLayout'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Xezun' => 'developer@xezun.com' }
  s.source           = { :git => 'https://github.com/Xezun/XZCollectionViewFlowLayout.git', :tag => s.version.to_s }
  ...
  s.subspec 'Code' do |ss|
    ss.source_files = 'XZCollectionViewFlowLayout/Code/**/*.swift'
